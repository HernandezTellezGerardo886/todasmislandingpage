...
@Component({
  selector: 'app-lo-mas-nuevo',
  templateUrl: './lo-mas-nuevo.component.html',
  styleUrls: ['./lo-mas-nuevo.component.css']
})
export class LoMasNuevoComponent implements OnInit {
